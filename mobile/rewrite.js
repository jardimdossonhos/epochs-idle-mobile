const fs = require('fs');
const content = `import { createStaticWorldData } from '../core/simulation/systems/world-system';
import { WORLD_DEFINITIONS_V1 } from '../application/boot/generated/world-definitions-v1';
import { WORLD_DEFINITIONS_MAP_ID } from '../application/boot/generated/world-definitions-map-id';
...
`;
fs.writeFileSync('src/__tests__/benchmark-save.test.ts', content);