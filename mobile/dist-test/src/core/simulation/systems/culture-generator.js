...
exports.DEFAULT_CULTURES = void 0;
exports.getRandomCulture = getRandomCulture;
exports.getRandomGender = getRandomGender;
exports.generateCulturalName = generateCulturalName;
exports.generatePortraitSeed = generatePortraitSeed;
const CULTURES = {
    nordic: {
...
exports.DEFAULT_CULTURES = ['nordic', 'latin', 'eastern', 'desert', 'celtic', 'slavic', 'savanna', 'indigenous', 'vedic'];
function getRandomCulture() {
    return exports.DEFAULT_CULTURES[Math.floor(Math.random() * exports.DEFAULT_CULTURES.length)];
}
function getRandomGender() {
    return Math.random() > 0.5 ? 'male' : 'female';
}
function generateCulturalName(cultureId, gender) {
