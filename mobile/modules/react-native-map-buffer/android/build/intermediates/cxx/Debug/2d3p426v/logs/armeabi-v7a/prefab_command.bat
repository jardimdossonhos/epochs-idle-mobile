...
"C:\\Program Files\\Microsoft\\jdk-21.0.12.8-hotspot\\bin\\java" ^
  ...
  27 ^
  --output ^
  "C:\\Users\\JOTI~1.SIM\\AppData\\Local\\Temp\\agp-prefab-staging11876951283860151615\\staged-cli-output" ^
  ...
  "C:\\Users\\joti.SIMPLO\\Documents\\Epochs_Idle\\mobile\\modules\\react-native-map-buffer\\android\\build\\intermediates\\cxx\\refs\\react-native-nitro-modules\\301l30c2" ^
